...
const Header = () => {
  ...
  return (
    <header className={`flex justify-between items-center p-4 text-black bg-white h-[8rem] dark:bg-neutral-900`}>
      ...
      <button className="hidden pr-5 other:flex dark:text-white">
      ...
      <nav className={`
        ${sideBar ? '1`other:opacity-100 other:translate-y-0' : 'other:opacity-0 other:translate-y-full'}
...
{/* <nav className={`flex px-8 transition-transform duration-300 transform other:justify-around other:flex-col other:absolute other:dark:bg-neutral-900 other:bg-white other:w-full other:h-full other:left-0 other:top-[8rem]`}> */}
        ...
        <button className="pr-5 other:hidden dark:text-white">
        {darkMode? <MdLightMode
        onClick={()=>setDarkMode(!darkMode)}
        /> : <FaMoon onClick={()=>setDarkMode(!darkMode)}/>}
      </button>
          ...
          <ul className={`${!pracBar  && 'hidden'} ${actPrac ? "other:translate-x-0 other:opacity-100" : "other:translate-x-full other:opacity-0" } 
          ...
          <ul className={`${!aboutBar && 'hidden'} ${actAbout ? "other:translate-x-0 other:opacity-100" : "other:translate-x-full other:opacity-0" }
          ...
          <ul className={`${!ourTeam  && 'hidden'} ${actTeam ? "other:translate-x-0 other:opacity-100" : "other:translate-x-full other:opacity-0" } absolute other:w-full other:space-y-3 other:justify-center other:bg-white other:h-full other:pb-[20rem] other:z-10 other:left-0 
