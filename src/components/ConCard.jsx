...
export const ConCard = ({className, title,b1, b2}) => {
  return (
    ...
    {title === "Contact"?  "" : <Link to='/contact' className={`flex justify-center items-center px-10 py-4 m-5 w-full max-h-16 text-xl rounded-sm border-2 hover:scale-95 ${b2}`}>
      Contact Us
    </Link> }
  </div>
  )
